...
> <Напиши здесь 1–2 предложения — главный вывод коуча об этой встрече: что важнее всего и на чём сфокусироваться. Конкретно по этой встрече, не шаблонно. КАЖДУЮ строку этого блока начинай с "> ", чтобы текст был внутри callout.>
...
> [!question] К следующей встрече
> <1 предложение: на чём сфокусировать следующую планёрку, исходя из открытых вопросов, блокеров и задач без результата. КАЖДУЮ строку этого блока начинай с "> ".>

**Вопросы сотрудникам (собрать ответы ДО следующей планёрки):**
