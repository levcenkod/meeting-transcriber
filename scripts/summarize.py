...
ПРАВИЛА:
- Без раздела «Карта обсуждения», «Статус по разделам», «Последовательность работ», «Бизнес-контекст», «Контекст», «Наблюдения о встрече» — их содержание уходит во «Взгляд со стороны».
